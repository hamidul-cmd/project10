...
function CommonHero({capsule, tittle, pera}) {
    ...
    <>
      <section className='px-4 mb-20 xll:px-20 xll:mb-36.5 3xl:mb-[200px] 3xl:px-12.5'>
        <div className="hero__wrapper bg-white rounded-10 border-2 border-gray-15 shadow-black-big px-7.5 py-12.5 relative xll:px-20 xll:py-24.5 3xl:py-36.5 3xl:px-[120px] 3xl:rounded-xl font-outfit flex flex-wrap justify-between gap-5">
            <div ref={heroleftref} className='space-y-2.5 w-fit m-auto xll:max-w-[535px] 3xl:max-w-[765px]'>
                ...
                <h1 className='text-28 font-bold l-130 font-raleway text-gray-10 text-center ll:mt-2.5 xll:text-38 xll:text-left 3xl:text-5xl 3xl:mt-3.5'>{tittle}</h1>
            </div>
            <p ref={herorightref} className='max-w-[535px] text-center text-base l-150 text-gray-20 font-medium m-auto xll:text-left 3xl:max-w-[765px] 3xl:text-xl'>{pera}</p>
            <div className='absolute top-0 left-0 z-10'>
                <img src={heroabs} alt="heroabs" className='h-24.5 w-24.5 xll:h-[137px] xll:w-[137px] 3xl:h-[200px] 3xl:w-[200px]' />
            </div>
        </div>
      </section>
    </>
